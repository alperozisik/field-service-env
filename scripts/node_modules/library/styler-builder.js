...
function getCombinedStyle(_className, _userStyle) {
  ...
  var userStyle = _userStyle || {};
  return Object.assign({}, getPropsFromStyle(styling, _className), userStyle);
}
...
function getOneProp(key, value) {
  ...
  if (ENUMS[key]) {
    ...
    res = Font.create(value.famil || "Arial", value.size || 12, getFontStyle(value));
  }
  else {
    res = value;
  }
